...
Copy-Item -LiteralPath (Join-Path $projectDir 'mobile\app\build\outputs\apk\release\app-release.apk') -Destination (Join-Path $projectDir 'artifacts\ColdDrop-1.0.0.apk')
Write-Output 'Created artifacts\ColdDrop-1.0.0.apk'
